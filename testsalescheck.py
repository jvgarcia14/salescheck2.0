...
ALLOWED_PAGES = {
    ...
    "#zoe": "Zoe",
    "#jaiden": "Jaiden",
    "#celinapaidfree": "Celinapaidfree",
    "#wettmelons": "Wett Melons",
    ...
    "#catelyn": "Catelyn",
    "#sethi": "Sethi",
    "#briBronDanAutumnOFTV": "BriBronDanAutumnOFTV",
    "#sarahlloyd": "Sarah Lloyd",
    "#Zoe": "zoe",
    "#marco": "Marco",
    "#Alexa Lana/Scarlette Moon": "AlexaLana/ScarletteMoon",
    "#Autumn,Bri,Dan,Bron OFTV": "Autumn,Bri,Dan,BronOFTV",
